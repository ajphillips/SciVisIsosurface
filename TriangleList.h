//This header file contains a TriangleList class with simple inline functions to add each triangle from
//the triCase array into the list to be rendered as an isosurface.
